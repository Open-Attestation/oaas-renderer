...
import { sample } from '../certificate-of-completion-2-signees-v2.sample'
...
describe('GovtechDigitalAcademyCertificateOfCompletion_2SigneesV2Template', () => {
    it('should match snapshot', () => {
        ...
        expect(tree).toMatchInlineSnapshot(`
            .c1 {
              ...
              background-image: url('COC-BGv2.png');
              z-index: initial;
            }
            ...
            >
              ...
              >
                ...
                <div
                  className="absolute top-[420px] left-[472px] h-[1px] w-[568px] bg-[#99753E]"
                />
                <div
                  className="c6"
                >
