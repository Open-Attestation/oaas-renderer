...
export const SmartNationLogoComponent = styled.div`
    ...
    display: flex;
`
export const SmartNationLogoImg = styled.img`
    display: block;
    width: 292.96px;
    height: 66.01px;
`
...
export const OfCompletionComponent = styled.div`
    position: absolute;
    width: 364px;
    height: 50px;
    left: 568.32px;
...
export const ProudlyPresentedComponent = styled.div`
    position: absolute;
    width: 244px;
    height: 22px;
    left: 629.78px;
...
export const InfoContainer = styled.div`
    ...
    color: #2b2c2b;
`
export const ForAchievingComponent = styled.div``
export const YourCommitmentComponent = styled.div``
export const ProgrammeComponent = styled.div`
    font-family: 'Montserrat';
    font-style: normal;
    font-weight: 600;
    padding: 14px 0;
