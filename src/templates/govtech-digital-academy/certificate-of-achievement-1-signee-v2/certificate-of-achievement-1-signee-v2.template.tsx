...
import {
    Typography,
    OfParticipation,
} from './certificate-of-achievement-1-signee-v2.components'
...
export const GovtechDigitalAcademyCertificateOfAchievement_1SigneeV2Template: FunctionComponent<
    TemplateProps<GovtechDigitalAcademyCertificateOfAchievement_1SigneeV2OaDoc> & {
        className?: string
    }
> = ({ document }) => {
        ...
        <>
            <Helmet>
                ...
                <title>
                    ...
                    certificate-of-achievement-1-signee-v2
                </title>
            </Helmet>
            <ScalableDocument
