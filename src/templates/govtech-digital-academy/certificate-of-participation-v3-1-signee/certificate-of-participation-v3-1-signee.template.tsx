...
import {
    OfParticipation,
    Typography,
} from './certificate-of-participation-v3-1-signee.components'
...
export const GovtechDigitalAcademyCertificateOfParticipationV3_1SigneeTemplate: FunctionComponent<
    TemplateProps<GovtechDigitalAcademyCertificateOfParticipationV3_1SigneeOaDoc> & {
        className?: string
    }
> = ({ document }) => {
        ...
        <>
            <Helmet>
                ...
                <title>
                    ...
                    certificate-of-participation-v3-1-signee
                </title>
            </Helmet>
            <ScalableDocument
