...
export const GovtechDigitalAcademyCertificateOfAchievement_2SigneesTemplate: FunctionComponent<
    TemplateProps<GovtechDigitalAcademyCertificateOfAchievement_2SigneesOaDoc> & {
        className?: string
    }
> = ({ document }) => {
        ...
        <>
            <Helmet>
                ...
                <title>
                    ...
                    certificate-of-achievement-2-signees
                </title>
            </Helmet>
            <ScalableDocument
