...
import { sample } from '../certificate-of-achievement-2-signees.sample'
import { GovtechDigitalAcademyCertificateOfAchievement_2SigneesTemplate } from '../certificate-of-achievement-2-signees.template'

describe('GovtechDigitalAcademyCertificateOfAchievement_2SigneesTemplate', () => {
    it('should match snapshot', () => {
        ...
        expect(tree).toMatchInlineSnapshot(`
            .c2 {
              ...
              background-image: url('COA_150dpi.png');
              z-index: initial;
            }
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className="absolute left-[475px] top-[192px] h-[77px] w-[568px] text-center text-[64px] font-bold leading-[76.8px] tracking-[0.04em] text-[#2B2C2B]"
                  >
                    CERTIFICATE
                  </div>
                  <div
                    className="c3 absolute left-[475px] top-[257px] h-[49px] w-[568px] text-center text-[41px] font-bold leading-[49.2px] tracking-[0.11em] text-[#99753E]"
                  >
                    OF ACHIEVEMENT
                  </div>
                  <div
                    className="absolute left-[475px] top-[327px] h-[24px] w-[568px] text-center text-[20px] font-normal leading-[24px] text-[#A4A3A3]"
                  >
                    PROUDLY PRESENTED TO
                  </div>
                  <div
                    className="absolute left-[475px] top-[375px] flex w-[568px] flex-col items-center"
                  >
                    <div
                      className="text-center text-[27px] font-bold leading-[32.4px] text-[#000000]"
                    >
                      THONG YONG JIE ANDRE
                    </div>
                    <div
                      className="mt-[10px] h-[1px] w-[568px] bg-[#99753E]"
                    />
                    <div
                      className="mt-[16px] h-[20px] text-center text-[17px] font-normal leading-[20.4px] text-[#000000]"
                    >
                      for your active participation in
                    </div>
                    <div
                      className="mt-[10px] whitespace-pre-line text-center text-[21px] font-bold leading-[25.2px] tracking-[0.01em] text-[#000000]"
                    >
                      Google AI Bootcamp 
             22 June 2023
                    </div>
                  ...
                  <div
                    className="absolute bottom-[68px] right-[73px] flex flex-row gap-[36px]"
                  >
                    <div
                      className="flex w-[256px] flex-col items-center"
                    >
                      <div
                        className="mb-[4px] flex h-[71px] w-[265px] flex-col items-center justify-end"
                      >
                        <img
                      ...
                      <div
                        className="mb-[7px] h-[1px] w-[265px] bg-[#99753E]"
                      />
                      <div
                        className="text-center text-[17px] font-normal leading-[17.34px] tracking-[0.01em] text-[#000000]"
                      >
                        <span
                  ...
                  <div
                    className="absolute left-[48px] top-[589px] flex flex-col items-start"
                  >
                    <div
                      className="text-[19px] font-normal leading-[22.8px] text-[#FFFFFF]"
                    >
                      Partner:
                    </div>
                    <div
                      className="mt-[6px] flex h-[100px] w-[280px] flex-col justify-end"
                    >
                      <img
                        alt="Signature of signee one"
                  ...
                  <div
                    className="absolute bottom-[27px] left-[43px] h-[19px] text-[16px] font-normal leading-[19.2px] text-[#FFFFFF]"
                  >
                    Date of Issue: 
                    10 May 2022
                  </div>
