...
import { sample } from '../certificate-of-participation-v3-2-signees.sample'
...
describe('GovtechDigitalAcademyCertificateOfParticipationV3_2SigneesTemplate', () => {
    it('should match snapshot', () => {
        ...
        expect(tree).toMatchInlineSnapshot(`
            .c2 {
              ...
              background-image: url('COP-BGv2.png');
              z-index: initial;
            }
            ...
            >
             ...
             22 June 2023
                  ...
                  >
                    <div
                      className="w-[256px] flex flex-col items-center"
                    >
                      <div
                  ...
                  <div
                    className="absolute top-[589px] left-[48px] flex flex-col items-start"
                  >
                    <div
                      className="text-[19px] leading-[22.8px] font-normal text-[#FFFFFF]"
                    >
                      Partner:
                    </div>
                    <div
                      className="w-[280px] h-[100px] mt-[6px] flex flex-col justify-end"
                    >
                      <img
                        alt="Signature of signee one"
