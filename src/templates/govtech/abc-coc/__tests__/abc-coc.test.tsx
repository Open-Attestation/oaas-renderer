...
import { sample } from '../abc-coc.sample'
import { GovtechAbcCocTemplate } from '../abc-coc.template'

describe('GovtechAbcCocTemplate', () => {
    it('should match snapshot', () => {
        const tree = renderer
            .create(
                <GovtechAbcCocTemplate
                    document={sample}
        ...
        expect(tree).toMatchInlineSnapshot(`
            .c1 {
              ...
              background-image: url('GTO-COC.png');
              z-index: initial;
            }
            ...
            >
              ...
              >
                ...
                <div
                  className="absolute w-[760px] h-[28px] top-[275px] left-[89px] text-[27px] tracking-[0.17em] font-normal text-[#FFFFFF] font-['Questrial']"
                >
                  OF COMPLETION
                </div>
                <div
                ...
                <div
                  className="absolute w-[940px] h-[55.06px] top-[408px] left-[89px] text-[43px] tracking-[0.12em] font-bold text-[#FFFFFF] font-['IBM_Plex_Serif']"
                >
                  JOHNATHAN DOE
                </div>
                <div
                  className="absolute w-[940px] h-[23.03px] top-[492px] left-[89px] text-[21px] tracking-[0.12em] font-normal text-[#FFFFFF] font-['Questrial']"
                >
                  has successfully completed the
                </div>
                <div
                  className="absolute w-[940px] h-[27px] top-[522px] left-[89px] text-[27px] tracking-[0.15em] font-normal text-[#FFFFFF] font-['Questrial']"
                >
                  AI Champions Bootcamp
                </div>
                <div
