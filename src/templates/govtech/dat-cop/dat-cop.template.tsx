...
import landscapeBg from '../common/assets/GTO-COP-silver.png'
import { GtoFormattedDate } from '../common/utils'
import { GovtechDatCopOaDoc } from './dat-cop.types'

export const GovtechDatCopTemplate: FunctionComponent<
    TemplateProps<GovtechDatCopOaDoc> & { className?: string }
> = ({ document }) => {
        ...
        <>
            ...
            <ScalableDocumentV2>
                <A4Landscape $bgImg={landscapeBg} $padding="0">
                    ...
                    <div className="absolute w-[760px] h-[28px] top-[275px] left-[89px] text-[27px] tracking-[0.19em] font-normal text-[#FFFFFF] font-['Questrial']">
                        OF PARTICIPATION
                    </div>
