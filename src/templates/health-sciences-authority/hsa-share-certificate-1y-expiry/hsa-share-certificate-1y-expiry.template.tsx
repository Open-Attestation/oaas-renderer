...
export const HealthSciencesAuthorityHsaShareCertificate_1yExpiryTemplate: FunctionComponent<
    TemplateProps<HealthSciencesAuthorityHsaShareCertificate_1yExpiryOaDoc> & {
        className?: string
    }
> = ({ document }) => {
