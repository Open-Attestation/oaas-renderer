                    ...
                    >
                        <FlexBox $vertical>
                            ...
                            <Typography
                                ...
                                $textAlign="center"
                            >
                                Outward Bound Singapore:<br></br> Challenge
                                Ropes Course (Basic)
                            </Typography>
                            <Typography $size={'medium'} $mt={0}>
                                On the date of
                    ...
                    <A4>
                        ...
                        <FlexBox $vertical $alignItems={'flex-start'}>
                            ...
                            <Typography $size={'small'}>
                                The curriculum for the Challenge Ropes Course
                                (CRC) Basic level programme aims to equip novice
                                ...
                                Rigging of OBS Ropes Courses, Ropes Course
                                Activity Management and Facilitation.
                            </Typography>
                            <Typography $size={'small'}>
                                ...
                                participant situations that do not require the
                                removal of the participant’s safety systems
                                while it is being used, and also the minor
                                rectification of belay systems on both
                            ...
                            <Typography $size={'small'}>
                                ...
                                processes to OBS Challenge Ropes Course
                                activities.<br></br>
