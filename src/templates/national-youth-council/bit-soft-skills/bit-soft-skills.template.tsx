                ...
                <A4 $bgImg={descriptionBg}>
                    <FlexBox $vertical $spacing={3}>
                        ...
                        <Table>
                            <tbody>
                                <tr>
                                    <RowHeader>Soft Skills 1a&1b </RowHeader>
                                    <td>
                                        Evidence, Philosophy, History,
                                        Professional Ethics, Trends and Issues
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Communication and Conditional Leadership
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Problem Solving, Decision Making & Sound
                                        Judgement Social Psychology and Group
                                        Management
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <FlexBox $vertical $spacing={1}>
                            <Typography $m={0}>
                                ...
                                gain knowledge, skills and attitude required to
                                conduct a safe and quality Outward Bound
                                Singapore Course.
                            </Typography>
                            <div>
                                <Typography $textAlign="left" $width="100%">
                                    Programme materials and content is largely
                                ...
                                <UnorderedList>
                                    ...
                                    >
                                        ...
                                        Outcome: A Practical Guide for
                                        Facilitating & Teaching Experiential
                                        Reflection. Wood ‘N’ Barnes Publishing
                                    </Typography>
                                    <Typography
                                        as="li"
                                        $italic
                                        ...
                                        $my={2}
                                    >
                                        Mark Collard (2014). Serious Fun: Your
