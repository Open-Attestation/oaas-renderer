...
export const NationalYouthCouncilBitSummaryCertificateFeb_2023Template: FunctionComponent<
    TemplateProps<NationalYouthCouncilBitSummaryCertificateFeb_2023OaDoc> & {
        className?: string
    }
> = ({ document, className = '' }) => {
                    ...
                    <FlexBox $vertical $spacing={3}>
                        ...
                        <FlexBox $vertical>
                            <Typography $size="medium" $mt={0}>
                                The Basic Instructor Training (BIT) is a core
                                part of the requirement for an Instructor to be
                                Operational (competent to lead and conduct OBS
                                courses). The 6 months training programme
                                incorporates the following outdoor skills and
                                competencies: Facilitation skills;
                                Organisational skills; Instructional skills;
                                Technical Activity skills; Safety and Risk
                                skills; Environmental skills; Field Deployment,
                                History, Philosophy, Typology of OAE, Trends and
                                Issues.
                            </Typography>
                            <Typography $size="medium" $my={0}>
                                The Trainee Instructors are also assessed in the
                                following areas: Skills Assessment (Trek, Life
                                Saving and Kayak); OBS Training Safety
                                Regulation; and OBS 5 days Expeditionary Course.
                                Upon completion of the BIT programme, the
                                Trainee Instructor will be deemed competent as
                                OBS Instructor and be assigned to conduct OBS
                                courses independently and any other operational
                                duties.
                            </Typography>
                        </FlexBox>
                        <Typography
                    ...
                    <FlexBox $vertical $spacing={3}>
                        ...
                        <div>
                            <Typography
                                ...
                                $m={0}
                            >
                                Facilitation, Organisational, Safety and Risk
                                Skills Training
                            </Typography>
                            <Table>
                                <tbody>
                            ...
                            <Typography $m={0}>
                                OBS - WSHC, Risk Analysis and Management System
                                and bizSAFE Level 2
                            </Typography>
                            <Typography $m={0}>
                            ...
                            <Typography $m={0}>
                                ...
                                Basic Cardiac Life Support and AED Certification
                            </Typography>
                            <Typography $m={0}>
                        ...
                        <Typography $m={0} $width="100%">
                            ...
                            <br />
                            Singapore Canoe Federation, Kayak Proficiency 1, 2,
                            3 Star
                            <br />
                            Singapore Sailing Federation, Dinghy Sailing Level 1
                            <br />
                            Singapore Life Saving Society, Life Saving Level 1,
                            2, 3, Bronze Medallion, and Bronze Cross
                            <br />
                            Outward Bound Singapore, Open Water Life Saving{' '}
                            <br />
                            Operations Familiarisation & Boat Handling (OBS Area
                            of Operations in Pulau Ubin) <br />
                        ...
                        <Typography $m={0} $width="100%">
                            ...
                            <br />
                            Singapore Mountaineering Federation, Sports Climbing
                            Level 1 & 2<br />
                            ...
                            Familiarisation, Troubleshooting and Aerial Rescue)
                            <br />
                        </Typography>
                        <Typography $m={0} $width="100%">
                            <Typography
