                ...
                <Root $vertical>
                    ...
                    <A4 $bgImg={descriptionBg}>
                        <FlexBox $vertical $spacing={3}>
                                    ...
                                    <MainOrderedList style={{ padding: 0 }}>
                                        <li>
                                            ...
                                            <Typography $m={0} $mt={0.5}>
                                                ...
                                                conduct basic navigation lessons
                                                to OBS participants.
                                            </Typography>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <Typography $m={0} $mt={0.5}>
                                                ...
                                                considerations of space, ground
                                                type and foliage density.
                                            </Typography>
                                        </li>
                                        <li>
                                            <Typography
                                            ...
                                            <Typography $m={0} $mt={0.5}>
                                                Gain knowledge on the advice
                                                needed for participants to be
                                                able to maintain proper personal
                                                and cooking hygiene in the
                                                field.
                                            </Typography>
                                        </li>
                                        <li>
                                            ...
                                            <Typography $m={0} $mt={0.5}>
                                                ...
                                                conduct a safe and quality land
                                                expedition.
                                            </Typography>
                                            <ul>
                                                <li>
                                                    Group management during
                                                    trekking
                                                </li>
                                                <li>
                            ...
                            <Typography $m={0}>
                                The curriculum for Campcraft and Navigation aims
                                to provide a list of competency modules to be
                                delivered in the training. The skills and
                                knowledge in the modules will enable
                                participants to conduct a safe and quality OBS
                                Courses (e.g. 5 Days MOE-OBS programme, PSOEB
                                programme, etc.) This include competencies in
                                map reading and basic orientation skills,
                                introduction to knots and lashings and how to
                                tie the respective knots and lashes as well as
                                its characteristics, camp-craftsmanship and
                                managing field hygiene, introducing to shelter
                                building and its application to different
                                location/campsites and application of risk
                                assessment management. Participants will also be
                                exposed to an introduction to the 7 principles
                                of Leave No Trace (LNT) as well as night
                                navigation.
                            </Typography>
                        </FlexBox>
                    </A4>
