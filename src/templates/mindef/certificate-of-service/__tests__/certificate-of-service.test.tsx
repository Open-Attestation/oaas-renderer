...
import { sample } from '../certificate-of-service.sample'
import { MindefCertificateOfServiceTemplate } from '../certificate-of-service.template'

describe('MindefCertificateOfServiceTemplate', () => {
    it('should match snapshot', () => {
        const tree = renderer
            .create(
                <MindefCertificateOfServiceTemplate
                    document={sample}
        ...
        expect(tree).toMatchInlineSnapshot(`
            ...
            <div
              id="mindef-certificate-of-service"
            >
              <div
                className="c0"
              >
                ...
                >
                  <div
                    className="absolute left-[115px] top-[510px] flex w-[568px] flex-col items-center"
                  >
                    <div
                  ...
                  <div
                    className="absolute left-[318px] top-[683px] flex flex-col items-center"
                  >
                    <div
                      className="text-center text-[21px] font-bold leading-[32.4px] text-[#000000]"
                    >
                      20 August 2024
                    </div>
                  </div>
                  <div
                    className="absolute left-[125px] top-[900px] flex flex-col items-center"
                  >
                    <div
                      className="text-center text-[21px] font-bold leading-[32.4px] text-[#000000]"
                    >
                  ...
                  <div
                    className="absolute bottom-[128px] right-[105px] flex flex-row gap-[36px]"
                  >
                    <div
                    ...
                    >
                      ...
                      <div
                        className="mb-[7px] h-[1px] w-[265px] bg-[#000000]"
                      />
                      <div
